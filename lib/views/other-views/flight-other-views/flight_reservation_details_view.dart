...
class FlightReservationDetailsView extends StatelessWidget {
  const FlightReservationDetailsView({
    super.key,
  });
  static String id = 'FlightReservationDetailsView';
  ...
  Widget build(BuildContext context) {
    ...
    if (flightTicketCubit.isCanceled) {
      ...
      reservationState = flightTicketCubit
          .getReservationsList[flightTicketCubit.saveReservationIndexValue!]
          .bookingStatusType;
      voidTime = flightTicketCubit
          .getReservationsList[flightTicketCubit.saveReservationIndexValue!]
          .flightBookingList!
          .first
          .voidTime;
      expireDate = DateTime.parse(flightTicketCubit
          .getReservationsList[flightTicketCubit.saveReservationIndexValue!]
          .bookingDate!);
      newExpireDate = expireDate.add(Duration(minutes: voidTime!));
      isHaveVoidTime = DateTime.now().isBefore(newExpireDate);
    }
                                                      ...
                                                      children: [
                                                        ...
                                                        GestureDetector(
                                                          onTap: () async {
                                                            ...
                                                            Navigator.pop(
                                                                context);
                                                            await flightTicketCubit.voidTicket(
                                              ...
                                              child: SlideCountdownSeparated(
                                                duration: Duration(
                                                  ...
                                                  hours: newExpireDate
                                                      ...
                                                      .inHours
                                                      .remainder(24),
                                                  minutes: newExpireDate
                                                      .difference(
                                                          DateTime.now())
                                                      .inMinutes
                                                      .remainder(60),
                                                  seconds: newExpireDate
                                                      .difference(
                                                          DateTime.now())
                                                      .inSeconds
                                                      .remainder(60),
