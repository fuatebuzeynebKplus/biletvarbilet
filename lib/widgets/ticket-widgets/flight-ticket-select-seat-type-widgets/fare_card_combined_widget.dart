...
class FareCardCombinedWidget extends StatelessWidget {
  const FareCardCombinedWidget(
  ...
  Widget build(BuildContext context) {
    ...
    dynamic result = flightTicketCubit.flightFaresLeaving!.first;
    ...
    for (int i = 0;
        i <
            flightTicketCubit.flightFaresLeaving!.first.fares![index]
                .fareAlternativeLegs!.length;
        i++) {
      var item = flightTicketCubit
          .flightFaresLeaving!.first.fares![index].fareAlternativeLegs![i];
...
// Example fare services
    ...
    // for (var itemA in flightTicketCubit.flightFaresLeaving!) {
    ...
    for (var element in flightTicketCubit.flightFaresLeaving!.first.fares!) {
    ...
    dynamic farePrice = flightTicketCubit
        .flightFaresLeaving!.first.fares![index].totalPrice!.totalAmount
        .toDouble();
    ...
    String fareCurrencyCode = flightTicketCubit.flightFaresLeaving!.first
        .fares![index].totalPrice!.currencyCode!; // Example currency code
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: flightTicketCubit.saveIndexFareForCombinedPackage !=
                            null
                        ? Border.all(
                            width: 2,
                            color: color, // Example color
                      ...
                      Expanded(
                        child: GestureDetector(
                            onTap: () {
                              ...
                              flightTicketCubit
                                  .selectListFareIndexForCombinedFunction(
